 ...
 *      - Sends remaining 99.4% to ShopAddress
 *
 ...
 * 5. Contract sends 99.4% to ShopAddress
 *
...
contract Transfer5 is Ownable, ITokenReceiver {
     ...
     * @param _shopAddress Address to receive 99.4% of JPYC
    ...
    function _processPayment(uint256 amount, address sender) internal {
        // Calculate 0.5% for JAPointMint, 0.1% fee for company, 99.4% for shop
        uint256 japointMintAmount = amount / 200; // 0.5%
        uint256 feeAmount = amount / 1000; // 0.1%
        uint256 shopAmount = amount - japointMintAmount - feeAmount; // 99.4%
        ...
        // Transfer remaining 99.4% to shop address
        require(
